Loco = function (options) {
    ...
    var locoPlace = new Object();
    var locoGrounding = new Object();
    var loco = new Object();
    //loco.shader = shaderHanlder.getShader("color-shader");
    var wheel = new Object("cylinder");
    //wheel = new Object("revolution");


    var axleTemplate = new Object("cylinder",{
        radius:0.048,
        height:0.6});
    axleTemplate.rotate({x:90});

    var wheelRadius = 0.2;
    var wheelTemplate = new Object("cylinder",{
        radius:wheelRadius,
        innerRadius:0.05,
        height:0.1});
    ...
    var tank = new Object("cylinder",{radius:0.22,height:0.8})
    tank.rotate({z:90});
    tank.translate({y:0.25,x:-0.22});

    var base = new Object("cuboid", {x:1.3,y:0.12,z:0.48});
    base.translate({y:0.05});
    base.vTexBuffer = null;

    var cabin = new Object("cuboid", {x:0.5,y:0.7,z:0.48});
    cabin.translate({y:0.45, x:0.38});
    cabin.vTexBuffer = null;

    var funnel = new Object("revolution",{
