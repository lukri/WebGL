...
Object.prototype.loadSetGeometry = function(taskName, options){
    var options = options || {};
...
Object.prototype.handleLoadedData = function(data, options){
...
Object.prototype.amountOfObjects = 0;
Object.prototype.pickingObjectArray = [];

Object.prototype.setObjectIndex = function(){
    Object.prototype.amountOfObjects += 1;
    this.index = Object.prototype.amountOfObjects;
    var i = this.index;
    ...
    Object.prototype.pickingObjectArray[index]=this;
};